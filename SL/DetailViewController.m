...
- (void)tableView:(UITableView *)tableView accessoryButtonTappedForRowWithIndexPath:(NSIndexPath *)indexPath {
    ...
    NSMutableString *newDate = [[[sms links] objectAtIndex:0] mutableCopy];
    [newDate insertString:@"-" atIndex:3];
    [newDate insertString:@" " atIndex:7];
    [newDate insertString:@" " atIndex:10];
    
    NSMutableArray *newLinks = [[sms links] mutableCopy];
    [newLinks replaceObjectAtIndex:0 withObject:newDate];
    
    [linksDetailViewController setLinks:newLinks];
